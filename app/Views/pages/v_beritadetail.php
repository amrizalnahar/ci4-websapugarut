			...
			<div class="row">
				<div class="col-lg-8 entries">
					<article class="entry entry-single">
						...
						<div class="entry-img">
							<img src="/img/<?= $berita['foto_berita']; ?>" alt="" class="img-fluid">
						</div>
						...
						<div class="entry-meta">
							<ul>
								<li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time datetime="01-01-2020"><?= $berita['updated_at']; ?></time></a></li>
							</ul>
						</div>
				...
				<div class="col-lg-4">
					...
					<div class="sidebar">
						...
						<div class="sidebar-item recent-posts">
							<?php foreach ($list_berita as $a) : ?>
								<div class="post-item clearfix">
									<img src="/img/<?= $a['foto_berita']; ?>" alt="">
									<h4><a href="<?= $a['slug_berita']; ?>"><?= $a['judul_berita']; ?></a></h4>
