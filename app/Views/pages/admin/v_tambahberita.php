...
<div class="container-fluid">
  <div class="row">
    <div class="col-10">
      <h2 class="my-3">Ini Form Tambah Berita</h2>

      <form action="/adminberita/save" method="POST" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <textarea class="form-control editable_inline" id="isi_berita" name="isi_berita"><?= old('isi_berita'); ?></textarea>
          </div>
        </div>
        <div class="row mb-3">
          ...
          <div class="col-sm-8">
            <div class="input-group mb-3">
              <input type="file" class="form-control  <?= ($validation->hasError('foto_berita')) ? 'is-invalid' : ''; ?>" id="foto_berita" name="foto_berita" onchange="previewImgbrt()">
              <label class="input-group-text myPreviewgambar" for="foto_berita">Pilih Gambar</label>
              <div id="validationServer03Feedback" class="invalid-feedback">
